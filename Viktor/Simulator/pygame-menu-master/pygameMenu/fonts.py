...
FONT_8BIT = __fontdir.format(__actualpath, 'OpenSans-Regular')
FONT_BEBAS = __fontdir.format(__actualpath, 'OpenSans-Regular')
FONT_FRANCHISE = __fontdir.format(__actualpath, 'OpenSans-Regular')
FONT_MUNRO = __fontdir.format(__actualpath, 'OpenSans-Regular')
FONT_NEVIS = __fontdir.format(__actualpath, 'OpenSans-Regular')
